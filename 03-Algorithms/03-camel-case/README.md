...
In this activity you'll be writing code to create a function that takes a string and returns the string in camel case.

## Instructions

* Open [Unsolved/camel-case.js](Unsolved/camel-case.js) in your code editor&mdash;this is the only file you'll modify in this activity.

  * In this file, you'll be writing code in the body of the `camelCase` function to achieve the following:
